...
/* Defines what a Card on the homepage looks like. It will display the 
photo and when hovered over, display the name, prompt, and downloadImage 
icon that when clicked, downloads the image. Tailwind CSS is used to 
dictate all style. */
const Card = ({ _id, name, prompt, photo }) => {
  return (
    ...
    hover:shadow-cardhover card">
      ...
      hidden absolute bottom-0 left-0 right-0 bg-zinc-700 m-2 
      p-4 rounded-md">
