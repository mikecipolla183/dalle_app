...
const CreatePost = () => {
  // Creates States for Generating and Loading and allows navigation.
  ...
  // Submit Image to Database Function
  ...
  // Takes Input from Keyboard and connects it to the FormField.
  const handleChange = (e) => {
    setForm({ ...form, [e.target.name]: e.target.value })
  }

  // Fetches the Random Prompt to be used in the FormField.
  const handleSurpriseMe = () => {
    const randomPrompt = getRandomPrompt(form.prompt);
    setForm({ ...form, prompt: randomPrompt })
  }
  
  // All style and layout of the CreatePost page.
  return (
